...
sidebar_position: 3
title: MUSEにおけるエビデンス
description: 研究エビデンスがどのように構造化され、検証され、ロジックモデルに接続されるか
---

# MUSEにおけるエビデンス

エビデンスはMUSEの中核です。ロジックモデルのあらゆる因果のつながりに研究エビデンスを裏付けとして付加できるため、セオリー・オブ・チェンジは単なる図表を超えて、防衛可能な研究に裏付けられたインパクト計画となります。
...
これらの概念については、[用語集](../reference/glossary)を参照してください。
